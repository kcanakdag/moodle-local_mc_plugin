...
$string['bulk_sync_button'] = 'Sync All Users';
$string['bulk_sync_cancel'] = 'Cancel';
$string['bulk_sync_cancelled'] = 'Cancelled. Synced {$a} users. Already-processed events will still be handled by your automations.';
$string['bulk_sync_confirm'] = 'This will fire user_updated events for <strong>{$a} active users</strong>. Each event will be processed by your MoodleConnect automations and count toward your monthly action quota.';
$string['bulk_sync_desc'] = 'Fire user_updated events for all active users so your MoodleConnect automations can process existing data. This is useful for backfilling data after creating a new automation.';
$string['bulk_sync_error'] = 'Error after processing {$a} users. Already-processed events will still be handled by your automations.';
$string['bulk_sync_experimental'] = 'Experimental Feature';
$string['bulk_sync_failed_preflight'] = 'Failed to check status';
$string['bulk_sync_no_connection'] = 'Connect to MoodleConnect first.';
$string['bulk_sync_no_trigger'] = 'No active automation for user updates found. Create a user_updated automation in MoodleConnect first.';
$string['bulk_sync_progress'] = '{$a->processed} / {$a->total}';
$string['bulk_sync_quota_info'] = 'Current quota usage: {$a->used} / {$a->limit} actions. After sync: {$a->after} / {$a->limit}.';
$string['bulk_sync_quota_warning'] = 'Warning: This will exceed your monthly action quota. Some events may not be processed.';
$string['bulk_sync_skipped'] = ' {$a->count} skipped (IDs: {$a->ids}).';
$string['bulk_sync_status_users'] = '{$a} active users';
$string['bulk_sync_success'] = 'Done! Fired events for {$a} users.';
...
$string['error_invalid_event_class'] = 'Invalid event class: {$a}';
$string['error_invalid_event_class_not_event'] = 'Class is not a valid event: {$a}';
$string['error_invalid_site_key_format'] = 'Invalid site_key format';
$string['error_invalid_site_key_length'] = 'Invalid site key length (must be 16-128 characters)';
$string['error_invalid_site_secret_format'] = 'Invalid site_secret format';
$string['error_invalid_site_secret_length'] = 'Invalid site secret length (must be 16-128 characters)';
...
$string['event_password_reset_requested'] = 'Password reset requested';
$string['event_password_reset_requested_desc'] = 'Triggered when a user requests a password reset via the forgot-password form.';
...
$string['events_limit_resume'] = 'Events will resume automatically on <strong>{$a}</strong>, or <a href="https://moodleconnect.com/settings" target="_blank">upgrade your plan</a> to increase your limit immediately.';
$string['events_limit_usage'] = '<strong>Usage:</strong> {$a->current} / {$a->limit} ({$a->percent}%)';
$string['experimental_heading'] = 'Experimental Features';
