...
$string['action_error_action_failed'] = 'The action failed for an unknown reason. Check the Moodle debug log for details.';
$string['action_error_badge_not_active'] = 'Badge "{$a}" is not active. Activate it in Moodle before it can be awarded.';
$string['action_error_badge_not_found'] = 'Badge not found (ID {$a}). It may have been deleted in Moodle. Update the automation configuration.';
$string['action_error_badges_disabled'] = 'Badges are disabled on this site. Enable them at Site administration → Badges → Badge settings.';
$string['action_error_certificate_not_found'] = 'Certificate not found (ID {$a}). It may have been deleted in Moodle. Update the automation configuration.';
$string['action_error_cohort_not_found'] = 'Cohort not found (ID {$a}). It may have been deleted in Moodle. Update the automation configuration.';
$string['action_error_course_not_found'] = 'Course not found (ID {$a}). It may have been deleted in Moodle. Update the automation configuration.';
$string['action_error_enrolment_not_found'] = 'No enrolment record found for this user and course combination.';
$string['action_error_enrolment_plugin_missing'] = 'The enrolment plugin "{$a}" is not available on this site.';
$string['action_error_execution_exception'] = 'An unexpected error occurred during execution. This will be retried automatically.';
$string['action_error_execution_in_progress'] = 'This action is already being executed by another request. It will be retried automatically.';
$string['action_error_group_not_found'] = 'Group not found (ID {$a}). It may have been deleted in Moodle. Update the automation configuration.';
$string['action_error_invalid_payload'] = 'The event payload is missing required data (e.g. user ID). Check that the trigger event provides the expected fields.';
$string['action_error_invalid_request'] = 'Invalid request: a required field is missing from the action payload.';
$string['action_error_manual_enrol_not_enabled'] = 'Manual enrolment is not enabled for this course. Go to Course → Participants → Enrolment methods and enable Manual enrolments.';
$string['action_error_manual_enrol_plugin_missing'] = 'The manual enrolment plugin is not installed or enabled on this site.';
$string['action_error_message_send_failed'] = 'Failed to send the message. This will be retried automatically.';
$string['action_error_plugin_not_installed'] = 'The required plugin is not installed. Install it from the Moodle plugin directory: https://moodle.org/plugins/{$a}';
$string['action_error_role_not_found'] = 'Role not found (ID {$a}). It may have been deleted or the ID is incorrect.';
$string['action_error_unknown_action_type'] = 'Unknown action type "{$a}". The plugin may need updating.';
$string['action_error_user_not_enrolled'] = 'The user is not enrolled in the target course. Enrol the user first or add an "Enroll User" action before this one.';
$string['action_error_user_not_found'] = 'User not found (ID {$a}). The user may have been deleted from Moodle.';
...
$string['field_profileimageurl_100x100'] = 'Profile Image URL (100x100)';
$string['field_profileimageurl_35x35'] = 'Profile Image URL (35x35)';
$string['field_profileimageurl_512x512'] = 'Profile Image URL (512x512)';
...
$string['messageprovider:automation'] = 'MoodleConnect automation notifications';
...
$string['privacy:metadata:executions'] = 'Records of local actions executed on behalf of users by MoodleConnect automations (e.g. certificates issued, badges awarded).';
$string['privacy:metadata:executions:action_type'] = 'The type of action that was executed (e.g. issue_certificate, award_badge).';
$string['privacy:metadata:executions:executed_at'] = 'The timestamp when the action was executed.';
$string['privacy:metadata:executions:result'] = 'The result of the action execution (success/failure details).';
$string['privacy:metadata:executions:user_id'] = 'The Moodle user ID of the user the action was performed on.';
