...
$string['bulk_sync_heading'] = 'Bulk User Sync';
...
$string['bulk_sync_progress'] = '{$a->current} / {$a->total} users';
...
$string['bulk_sync_success'] = 'Done! Fired events for {$a} users. Check your MoodleConnect logs to monitor processing.';
